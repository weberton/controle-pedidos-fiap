...
import br.com.fiap.controlepedidos.core.application.services.order.impl.GetAllOrdersReadyServiceImpl;
...
class GetAllOrdersReadyServiceImplTest {
    ...
    @InjectMocks
    private GetAllOrdersReadyServiceImpl service;
    ...
    void getAll_ShouldReturnOrdersWithCustomersLoaded() {
        ...
        when(orderRepository.findByOrderStatusOrderByUpdatedAtAsc(OrderStatus.READY, pageable))
        ...
        assertThat(result.getContent())
                ...
                .containsExactly("Customer A", "Customer B");

        verify(orderRepository, times(1)).findByOrderStatusOrderByUpdatedAtAsc(OrderStatus.READY, pageable);
