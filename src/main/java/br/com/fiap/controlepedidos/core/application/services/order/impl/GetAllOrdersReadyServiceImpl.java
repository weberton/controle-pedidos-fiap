...
public class GetAllOrdersReadyServiceImpl implements GetAllOrdersReadyService {
    ...
    public GetAllOrdersReadyServiceImpl(IOrderRepository orderRepository) {
        this.orderRepository = orderRepository;
    }

    @Override
    public Page<Order> getAll(Pageable pageable) throws Exception {
        return orderRepository.findByOrderStatusOrderByUpdatedAtAsc(OrderStatus.READY, pageable);
    }
}
